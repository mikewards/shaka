      ...
      builder: (context) => Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            _buildFactorRow(context, 'Visibility', '25%', 'Water clarity from satellite & weather data'),
            _buildFactorRow(context, 'Weather', '20%', 'Wind, rain, and cloud conditions'),
            _buildFactorRow(context, 'Swell', '15%', 'Wave height and period'),
            _buildFactorRow(context, 'Fish Activity', '15%', 'Moon phase, season, recent sightings'),
            _buildFactorRow(context, 'Safety', '15%', 'Currents, hazards, shark risk'),
            _buildFactorRow(context, 'Accessibility', '10%', 'Ease of entry, parking, permits'),
            const SizedBox(height: 16),
            Container(
